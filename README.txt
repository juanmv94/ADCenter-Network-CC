...
* For the first challenge, string input is hardcoded. You can compile it with following command: ghc Challenge1.hs
* For the second challenge, I used the "interact" function that reads input from STDIN and outputs to STDOUT the result of a function in real time.  You can compile it with following command: ghc Challenge2.hs
* There's also a unit test hs. You can compile it with following command: ghc Test.hs
...
Downloading and Installing Haskell (Windows)
------------------------------------------------

You can download Haskell Installer here https://downloads.haskell.org/~ghc/7.4.2/ghc-7.4.2-i386-windows.exe (87 MB)
